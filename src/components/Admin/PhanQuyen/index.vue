...
export default {
    ...
    methods: {
        ...
        capQuyen(id_chuc_nang) {
            ...
            axios
                .post('http://127.0.0.1:8000/api/admin/phan-quyen/chi-tiet-phan-quyen/add-data', payload, {
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
        ...
        phanQuyen(value) {
            ...
            axios
                .post('http://127.0.0.1:8000/api/admin/phan-quyen/chi-tiet-phan-quyen/data', this.chon_chuc_vu, {
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
        ...
        xoaQuyen(value) {
            axios
                .post('http://127.0.0.1:8000/api/admin/phan-quyen/chi-tiet-phan-quyen/delete', value, {
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("key_admin")
                    }
                })
