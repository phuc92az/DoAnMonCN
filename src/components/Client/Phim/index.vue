    ...
    <div class="container mt-3">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-img-top">
                        <img src="https://cdn.galaxycine.vn/media/2025/5/9/yadang-500_1746783491666.jpg"
                            class="img-fluid" alt="">
                    </div>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-img-top">
                        <img src="https://cdn.galaxycine.vn/media/2025/5/6/de-men-500_1746513868460.jpg"
                            class="img-fluid" alt="">
                    </div>
                    <div class="card-img-overlay text-center" style="margin-top: 200px;">
                        <div class="col">
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-img-top">
                        <img src="https://cdn.galaxycine.vn/media/2025/5/6/the-butterfly-house-2_1746500691670.jpg"
                            class="img-fluid" alt="">
                    </div>
                    <div class="card-img-overlay text-center" style="margin-top: 200px;">
                        <div class="col">
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-img-top">
                        <img src="https://cdn.galaxycine.vn/media/2025/5/9/doraemon-the-movie-nobitas-art-world-tales-1_1746800200069.jpg"
                            class="img-fluid" alt="">
                    </div>
                    <div class="card-img-overlay text-center" style="margin-top: 200px;">
                        <div class="col">
